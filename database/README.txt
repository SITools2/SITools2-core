...
Pour les données de test MongoDB :
Exécuter la commande suivante :
mongorestore -h <host de la base mongodb> -d <nom de la base> dump_mongodb
Cela va créer l'ensemble des collections nécessaire à l'éxécution des tests unitaires sur MongoDB