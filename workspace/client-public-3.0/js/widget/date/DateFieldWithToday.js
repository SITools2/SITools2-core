...
Ext.define('sitools.public.widget.date.DateFieldWithToday', {
    ...
    getErrors: function (value) {
        ...
        if (this.minValue && time < this.minValue.clearTime().getTime()) {
            errors.push(Ext.String.format(this.minText, Ext.util.Format.date(this.minValue)));
        }

        if (this.maxValue && time > this.maxValue.clearTime().getTime()) {
            errors.push(Ext.String.format(this.maxText, Ext.util.Format.date(this.maxValue)));
        }
        ...
        var fvalue = Ext.util.Format.date(value);
    ...
    setValue: function (date) {
        if (this.regToday.test(date)) {
            return Ext.form.field.Date.superclass.setValue.call(this, date);
        }
        else {
            return Ext.form.field.Date.superclass.setValue.call(this, Ext.util.Format.date(this.parseDate(date)));
