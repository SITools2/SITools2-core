 ...
 */
Ext.define('sitools.public.widget.imageChooser.TriggerField', {
    alternateClassName : ['Ext.form.SitoolsSelectImage'],
    extend : 'Ext.form.TriggerField',
	alias : 'widget.sitoolsSelectImage',
	
	requires : ['sitools.public.widget.imageChooser.ImageChooser'],
