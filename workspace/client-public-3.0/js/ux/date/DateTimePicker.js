...
//	  override: "Ext.ux.date.DateTimePicker",
//	  todayText: "Now",
//	  timeLabel: 'Time'
//  });

Ext.define('Ext.ux.date.DateTimePicker', {
	  extend: 'Ext.picker.Date',
	  alias: 'widget.datetimepicker',
	  requires: ['Ext.ux.date.form.TimePickerField'],
	  ...
	  onRender: function(container, position) {
		  if(!this.timefield) {
			  this.timefield = Ext.create('Ext.ux.date.form.TimePickerField', {
