 ...
 * @author m.gond
 */
public class WgetListFileCartOrderResourceTestCase extends AbstractTaskResourceTestCase {
  ...
  private String orderResourceModelClassName = "fr.cnes.sitools.resources.order.cart.wget.WgetListFileOrderResourceModel";
   ...
   */
  @Test
  public void testOrder() throws ClassNotFoundException, InstantiationException, IllegalAccessException,
    ...
    TaskModel taskModel = invokeOrder(urlAttach, "?cartFile=" + cartFile + "&fileName=" + fileName);
