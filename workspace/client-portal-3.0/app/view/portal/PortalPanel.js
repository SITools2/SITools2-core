 ...
 */
Ext.define('sitools.clientportal.view.portal.PortalPanel', {
    extend: 'Ext.panel.Panel',
    alias: 'widget.portalpanel',

    requires: [
        'Ext.layout.container.Column',
        'sitools.clientportal.view.portal.PortalDropZone',
    ...
    initEvents : function(){
        this.callParent();
        this.dd = Ext.create('sitools.clientportal.view.portal.PortalDropZone', this, this.dropConfig);
    },
