 ...
 ******************************************************************************/
/*
 * global Ext, sitools, i18n, userLogin, DEFAULT_ORDER_FOLDER, document,
 * alertFailure, SITOOLS_DATE_FORMAT, SITOOLS_DEFAULT_IHM_DATE_FORMAT, sql2ext,
 * getDesktop, getColumnModel, extColModelToStorage, SitoolsDesk, projectGlobal,
 * DEFAULT_PREFERENCES_FOLDER, DEFAULT_LIVEGRID_BUFFER_SIZE, loadUrl,
 * ColumnRendererEnum
 */
/*
 * @include "contextMenu.js" @include "../../viewDataDetail/viewDataDetail.js"
 * @include "../../plot/dataPlotter.js" @include "contextMenu.js" @include
 * "storeLiveGrid.js"
 */
Ext.namespace('sitools.user.component.dataviews.tplView');

/**
 * Define the sitools DataView to display Datasets via an Ext.Dataview Build an
 * Ext.DataView corresponding to the dataset Definition.
 * 
...
sitools.user.component.dataviews.tplView.TplView = function (config) {
    ...
    this.store.on("beforeload", function (store, options) {
        ...
        // before load is called only when a new action (sort, filter) is
        // applied
        var noCount;
    ...
    this.dataView = new Ext.DataView({
        ...
        listeners : {
            ...
            selectionchange : function (dataView, recNodes) {
                ...
                // destroy all selections if all was selected and another row is
                // selected
...
Ext.extend(sitools.user.component.dataviews.tplView.TplView, Ext.Panel, {
    ...
    getRequestParam : function () {
        ...
        if (Ext.isEmpty(selections)) {
            ...
            if (this.isAllSelected()) {
                ...
                // We have to re-build all the request in case we use a range
                // selection.
                request += this.getRequestParamWithoutSelection();
            } else {
     ...
     *            recSelected the selected records
    ...
    /**
     * @public return the sortInfo of the TplView.
