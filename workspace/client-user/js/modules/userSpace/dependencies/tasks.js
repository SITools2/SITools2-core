...
sitools.user.modules.userSpaceDependencies.tasks = Ext.extend(Ext.grid.GridPanel, {
    border : false,
    ...
    initComponent : function () {
        ...
        sitools.user.modules.userSpaceDependencies.tasks.superclass.initComponent.call(this);
    },

    onRender : function () {
        sitools.user.modules.userSpaceDependencies.tasks.superclass.onRender.apply(this, arguments);
        this.store.load({
            params : {
                start : 0,
                limit : this.pageSize
    ...
    _onViewStatusDetails : function () {
        ...
        var jsObj = sitools.user.modules.userSpaceDependencies.tasksDetails;
        var componentCfg = {
            sva : rec.data    
        };
        var windowConfig = {
