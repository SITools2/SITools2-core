...
package fr.cnes.sitools.resources.geojson;
 ...
 import fr.cnes.sitools.resources.html.HtmlExportRepresentation;
 ...
 public class GeoJSONPostGisResource extends SitoolsParameterizedResource {
   ...
   private Representation execute() {
     ...
     repr = new GeoJsonRepresentation(params, geometryColName, datasetApp.getConverterChained(), dataset, getContext());
