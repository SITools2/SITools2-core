                ...
                listeners : {
                    ...
                    select : function (combo, records) {
                        ...
                        if (record.data.textRssField == "linkField") {
                            var tmp = Ext.create('sitools.admin.datasets.relativeLink', {
...
Ext.define('sitools.admin.datasets.relativeLink', { 
    ...
    initComponent : function () {
        ...
        sitools.admin.datasets.relativeLink.superclass.initComponent.call(this);
    },
    afterRender : function () {
        sitools.admin.datasets.relativeLink.superclass.afterRender.apply(this, arguments);
