 ...
 * @class sitools.admin.usergroups.RegCrud
 * @extends Ext.grid.GridPanel
 */
Ext.define('sitools.admin.usergroups.RegCrud', {
    ...
    requires : ['sitools.admin.usergroups.RegProp'],
    ...
    afterRender : function () {
        sitools.admin.usergroups.RegCrud.superclass.afterRender.apply(this, arguments);
        this.store.load({
            start : 0,
            limit : this.pageSize
        });
    ...
    onModify : function () {
        ...
        var up = Ext.create('sitools.admin.usergroups.RegProp', {
            url : this.url + '/' + rec.get("id"),
            store : this.store
        });
        up.show(ID.BOX.REG);
