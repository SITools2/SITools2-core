...
sitools.admin.usergroups.BlacklistedUsersPanel = Ext.extend(Ext.Window, {
    ...
    initComponent : function () {
        ...
        sitools.admin.usergroups.BlacklistedUsersPanel.superclass.initComponent.call(this);
    },
     ...
     */ 
    onRender : function () {
        sitools.admin.usergroups.BlacklistedUsersPanel.superclass.onRender.apply(this, arguments);
        this.store.load({
            scope : this,
            params : {
                start : 0,
