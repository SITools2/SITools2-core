 ...
 * @class sitools.admin.usergroups.UserCrud
...
Ext.define('sitools.admin.usergroups.UserCrud', {
    ...
    requires : ['sitools.admin.usergroups.UserProp',
                'sitools.admin.usergroups.BlacklistedUsers'],
...
//        });
    ...
    _onBlacklistedUsers : function () {
        var up = Ext.create("sitools.admin.usergroups.BlacklistedUsers", {
