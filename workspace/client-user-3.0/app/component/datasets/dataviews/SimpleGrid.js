 ...
 */
Ext.define('sitools.user.component.datasets.dataviews.SimpleGrid', {
    extend : 'sitools.user.core.Component',
    
    controllers : ['sitools.user.controller.component.datasets.dataviews.SimpleGridController',
                   'sitools.user.controller.component.datasets.services.ServicesController'],
    
    requires : ['sitools.user.view.component.datasets.dataviews.SimpleGridView',
	...
	init : function (componentConfig, windowConfig) {
        ...
        var datasetStore = Ext.create("sitools.user.store.dataviews.DataviewStore", {
            fields : fields,
        ...
        componentSettings = Ext.apply(componentConfig, {
            ...
            origin : 'sitools.user.view.component.datasets.dataviews.SimpleLivegrid',
            dataviewConfig : dataviewConfig,
            sitoolsType : 'datasetView'
            // searchAction : this.searchAction,
        });
        
        var view = Ext.create('sitools.user.view.component.datasets.dataviews.SimpleGridView', componentSettings);
