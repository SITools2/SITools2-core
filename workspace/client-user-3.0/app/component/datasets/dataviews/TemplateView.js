...
Ext.define('sitools.user.component.datasets.dataviews.TemplateView', {
    ...
    controllers: ['sitools.user.controller.component.datasets.dataviews.TemplateViewController',
    ...
    init: function (componentConfig, windowConfig) {
        ...
        componentSettings = Ext.apply(componentConfig, {
            ...
            origin: 'sitools.user.view.component.datasets.dataviews.TemplateViewView',
            dataviewConfig: dataviewConfig,
            serviceController: serviceController,
            sitoolsType: 'datasetView'
        });

        var view = Ext.create('sitools.user.view.component.datasets.dataviews.TemplateViewView', componentSettings);
