...
Ext.define('sitools.user.view.component.datasets.dataviews.selectionModel.SelectionModel', {
    ...
    selectAll: function(suppressEvent) {
        var me = this,
            i = 0,
            len = me.store.getTotalCount(),
            start = me.getSelection().length;

        me.suspendChanges();
        for (; i < len; i++) {
            me.doSelect(i, true, suppressEvent);
        }
        me.resumeChanges();
...
//        });
     ...
     */
    selectRange : function(startRow, endRow, keepExisting, suppressEvent) {
        var me = this,
        ...
        me.doMultiSelect(toSelect, true, suppressEvent);
    },
    ...
    normalizeRowRange: function(startRow, endRow) {
        ...
        endRow = Math.min(endRow, store.getTotalCount() - 1);
...
//        }
    ...
    deselectDeletedRecords: function(){},
