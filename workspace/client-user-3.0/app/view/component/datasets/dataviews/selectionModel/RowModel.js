...
//        extend: "sitools.user.view.component.datasets.dataviews.selectionModel.SelectionModel",
        ...
        getCurrentPosition: function() {
            ...
            if (firstSelection) {
                return new Ext.grid.CellContext(this.view).setPosition(firstSelection, 0);
            }
        },
        ...
        selectNext: function(keepExisting, suppressEvent) {
            ...
            if (index === store.getTotalCount() || index === 0) {
                success = false;
            } else {
        ...
        isRowSelected: function(record, index) {
            if(Ext.isNumber(record)) {
                ...
                return this.isSelected(record.index);
            }
        }
    });