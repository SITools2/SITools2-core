 ...
 ******************************************************************************/
package fr.cnes.sitools.mock.authorizer;
...
import fr.cnes.sitools.plugins.filters.model.FilterParameterType;
 ...
 public class DataStorageAuthorizerModel extends FilterModel {
   ...
   public DataStorageAuthorizerModel() {
     ...
     setClassOwner("CNES");
     setClassVersion("0.1");
     setClassName("fr.cnes.sitools.mock.authorizer.DataStorageAuthorizerModel");

     setFilterClassName("fr.cnes.sitools.mock.authorizer.DataStorageAuthorizer");
