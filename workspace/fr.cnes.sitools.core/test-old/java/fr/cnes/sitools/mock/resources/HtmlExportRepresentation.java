...
public class HtmlExportRepresentation extends OutputRepresentation {
     ...
     * Default constructor
     *
     * @param mediaType the mediaType needed
     */
     ...
     *
     * @param mediaType  the mediaType needed
     * @param params     the DatabaseRequestParameters
    ...
    public void write(OutputStream outputStream) throws IOException {
        ...
        try {
            ...
            generateHTML(databaseRequest, out);
    ...
    private void generateHTML(DatabaseRequest databaseRequest, PrintStream out) {
        boolean headWriten = false;

        Record rec; // Create a structure to store header and rendering information for each column
