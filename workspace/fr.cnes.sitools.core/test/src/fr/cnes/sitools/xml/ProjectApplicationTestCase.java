...
/**
 * Test case for Project application API in XML 
 * 
...
public class ProjectApplicationTestCase extends fr.cnes.sitools.AbstractProjectApplicationTestCase {
  ...
  static {
    ...
    docAPI = new DocAPI(ProjectApplicationTestCase.class, "Project Administration and Monitoring API with XML format");
