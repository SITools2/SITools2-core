...
import fr.cnes.sitools.json.ProjectTestCase;

/**
 * Resource plugin tests in XML format
...
public class ResourcePluginTestCase extends AbstractResourcePluginTestCase {
  ...
  static {
    ...
    docAPI = new DocAPI(ProjectTestCase.class, "Resource plugin exposition API with XML format");
