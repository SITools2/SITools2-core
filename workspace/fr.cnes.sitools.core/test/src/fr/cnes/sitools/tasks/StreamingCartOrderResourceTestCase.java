...
public class StreamingCartOrderResourceTestCase extends AbstractTaskResourceTestCase {
  ...
  private String orderResourceModelClassName = "fr.cnes.sitools.resources.order.cart.StreamingOrderResourceModel";
  ...
  // */
  // @Test
  // public void testOrderResourceWithDownloadLimitNoLimitRequest() throws ClassNotFoundException,
