 ...
 */
public class GraphTestCase extends fr.cnes.sitools.AbstractGraphTestCase {

  static {
    setMediaTest(MediaType.APPLICATION_JSON);

    docAPI = new DocAPI(GraphTestCase.class, "Graph Administration API with JSON format");
