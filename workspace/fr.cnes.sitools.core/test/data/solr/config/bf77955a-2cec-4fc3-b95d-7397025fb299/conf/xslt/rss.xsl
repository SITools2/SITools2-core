...
<xsl:stylesheet version='1.0'
  ...
  <xsl:template match='/'>
    <rss version="2.0"
       ...
       <channel>
	 	<title>DataSet de test</title>
         	<link>/mondataset</link>
         	<description>
  ...
  <xsl:template match="doc">
    <item>
      <title><xsl:value-of select="str[@name='fname']"/></title>
      <link>
        <xsl:value-of select="str[@name='']"/>
      </link>
      <description>
        <xsl:value-of select="str[@name='cycle']"/>
      </description>
      <pubDate><xsl:value-of select="str[@name='lname']"/></pubDate>
      <guid>
