...
public final class Base64 {
  ...
  /**
   * Encodes up to the first three bytes of array <var>threeBytes and returns a four-byte array in Base64
   * notation. The actual number of significant bytes in your array is given by <var>numSigBytes. The array
   * <var>threeBytes needs only be as big as <var>numSigBytes. Code can reuse a byte array by passing a
   * four-byte array as <var>b4.
   * @param options options
   * @param b4
  ...
  /**
   * <p>
   * Encodes up to three bytes of the array <var>source and writes the resulting four Base64 bytes to
   * <var>destination. The source and destination arrays can be manipulated anywhere along their length by
   * specifying <var>srcOffset and <var>destOffset. This method does not check to make sure your arrays are
   * large enough to accomodate <var>srcOffset + 3 for the <var>source array or <var>destOffset + 4
   * for the <var>destination array. The actual number of significant bytes in your array is given by
   * <var>numSigBytes.
   * </p>
   * <p>
   ...
   * @return the <var>destination array
   * @since 1.3
   */
  ...
  /**
   * Decodes four bytes from array <var>source and writes the resulting bytes (up to three of them) to
   * <var>destination. The source and destination arrays can be manipulated anywhere along their length by
   * specifying <var>srcOffset and <var>destOffset. This method does not check to make sure your arrays are
   * large enough to accomodate <var>srcOffset + 4 for the <var>source array or <var>destOffset + 3
   * for the <var>destination array. This method returns the actual number of bytes that were converted from the
   * Base64 encoding.
   * <p>
  ...
  public static class InputStream extends java.io.FilterInputStream {
    ...
    /**
     * Calls {@link #read()} repeatedly until the end of stream is reached or <var>len bytes are read. Returns
  ...
  public static class OutputStream extends java.io.FilterOutputStream {
    ...
    /**
     * Calls {@link #write(int)} repeatedly until <var>len bytes are written.
     * 
     * @param theBytes
