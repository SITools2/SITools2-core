...
public abstract class AbstractCartOrderResource extends SitoolsResource {
   ...
   */
  private AbstractCartOrderApplication application = null;
  ...
  public void doInit() {
    ...
    application = (AbstractCartOrderApplication) getApplication();
  ...
  public CartSelections getObject(Representation representation, Variant variant) {
    
    return new CartSelections();
