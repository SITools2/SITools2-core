 ...
 */
public final class ResourcePluginNotificationResource extends SitoolsResource {
  ...
  public Representation notification(Representation representation, Variant variant) {
    try {
      ...
      if (representation != null) {
        getNotificationObject(representation);
      }
      // FIXME Delete parent => Delete resource model
