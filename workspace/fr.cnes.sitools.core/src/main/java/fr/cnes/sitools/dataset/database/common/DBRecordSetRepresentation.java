...
public final class DBRecordSetRepresentation extends OutputRepresentation {
    ...
    private boolean generateStream(OutputStream os) throws IOException {
        ...
        if (this.getMediaType().isCompatible(MediaType.APPLICATION_XML)
            ...
            ObjectOutputStream out = xstream.createObjectOutputStream(os, "root");
            ...
            try {
                ...
                if (databaseRequest.getCount() == 0) {
                    ...
                    out = xstream.createObjectOutputStream(os, "response");
