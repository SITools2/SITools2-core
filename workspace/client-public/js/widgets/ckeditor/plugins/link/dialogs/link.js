...
CKEDITOR.dialog.add( 'link', function( editor ) {
	...
	// Patch SITools
//	SitoolsDesk.getDesktop().getManager().register(this.getDialog());
...
//                            var urlField = dialog.getContentElement('info','url');
                            ...
                            if (!datasetField.dataLinkComponent || !this.getValue()){
                                alert(i18n.get('label.datasetLinkTextNeeded'));
                                return false;
                            }
                            return true;
                        ...
                        commit: function( data ) {
                            ...
                            data.datasetLink.text = this.getValue();
                            this.allowOnChange = false;
                        }
                    }
                ]
